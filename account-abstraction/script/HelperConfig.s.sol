...
contract HelperConfig is Script {
    ...
    address constant BURNER_WALLET = 0x777452cBc7E71B5286e60BA935292FFd49a597A5;
    ...
    function getConfigByChainId(uint256 chainId) public returns (NetworkConfig memory) {
        ...
        else if (networkConfigs[chainId].account != address(0)) return networkConfigs[chainId];
